...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=17&duration=2800&pause=900&color=79C0FF&center=true&vCenter=true&width=520&lines=B.Tech+CSE+%40+Bennett+University+%7C+CGPA+8.80;Built+AI+systems+with+satellite+data+%26+ML;200%2B+DSA+problems+solved+on+LeetCode+%26+GFG;Always+building.+Always+shipping.)](https://git.io/typing-svg)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0d1e3d?style=for-the-badge&logo=linkedin&logoColor=79c0ff&labelColor=0d1117)](https://linkedin.com/in/YOUR_LINKEDIN)
...
[![LeetCode](https://img.shields.io/badge/LeetCode-0d1117?style=for-the-badge&logo=leetcode&logoColor=ffa657&labelColor=0d1117)](https://leetcode.com/YOUR_HANDLE)
...
const aditya = {
  ...
  degree      : "B.Tech CSE  |  CGPA: 9.14  |  2024–2028",
  stack       : ["C++", "React.js", "Node.js", "TypeScript", "MongoDB", "MySQL"],
  currentWork : "AI-powered full-stack systems & ML integrations",
  dsa         : "200+ problems solved · LeetCode + GeeksforGeeks",
  achievements: ["SIH Internal – Rank 296", "Phantasia Hackathon Participant"],
  openTo      : "collabs, open-source, internships & interesting builds",
}; // always shipping.
```
...
![OOP](https://img.shields.io/badge/OOP-0d1117?style=for-the-badge&logoColor=d2a8ff&labelColor=0d1117)
![DSA](https://img.shields.io/badge/DSA-0d1117?style=for-the-badge&logoColor=6A5ACD&labelColor=0d1117)
...
### 🌾 Hybrid Crop Advisory System
> AI + satellite data + ML disease detection — end-to-end intelligent agriculture platform.

- Sentinel-2 satellite imagery → NDVI vegetation monitoring
- Rule-based decision engine for sowing & crop planning
- ML leaf disease detection for early-stage crop health
- Real-time weather data integration for risk-aware insights

**Stack:** `Python` `ML` `React` `Node.js` `REST API`

[![Live Demo](https://img.shields.io/badge/Live%20Demo-0d1117?style=flat-square&logo=vercel&logoColor=79c0ff&labelColor=0d1117)](https://your-demo-link.com)
[![Code](https://img.shields.io/badge/Code-0d1117?style=flat-square&logo=github&logoColor=ffffff&labelColor=0d1117)](https://github.com/adityasingh6533/repo)

</td>
<td width="50%" valign="top">

### ⚡ ForgeAI — AI Execution Workspace
> Convert raw ideas into structured project plans and dev workflows — automatically.

- Auto-generates feature breakdowns, API designs, execution roadmaps
- Task-based workflow system with contextual AI assistance
- Validation mechanisms for output testing & reliability
- Architected for multi-agent expansion

**Stack:** `React` `Node.js` `TypeScript` `AI APIs`
...
```
🏆  Smart India Hackathon (Internal)  →  Rank 296
🧩  Phantasia Hackathon              →  Strong solution · rapid prototyping · teamwork
💡  DSA                              →  200+ problems · LeetCode + GeeksforGeeks
🎓  CGPA                             →  9.14 / 10.0  @  Bennett University
```
...
<img src="https://github-readme-streak-stats.herokuapp.com/?user=adityasingh6533&theme=github-dark-blue&hide_border=true&stroke=0d1117&ring=1f6feb&fire=d2a8ff&currStreakLabel=79c0ff&sideLabels=6e7681&dates=484f58&background=0d1117" width="68%"/>
...
<img src="https://github-profile-trophy.vercel.app/?username=adityasingh6533&theme=onestar&no-frame=true&no-bg=true&margin-w=6&column=7"/>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:0d1e3d,100:1a0d2e&height=110&section=footer&animation=fadeIn"/>

`// B.Tech CSE · Bennett University · 2024–2028`
